...
# Создание хеш-паролей для шаблонных данных.
...
# Проверка пароля на сходство с паролем, который находится в файле
def password_verification(login_def, password_input):
    ...
    if password_in_csv == password_input:
        return f'Пароль верный! Добро пожаловать {login_def}.'
    else:
...
# По умолчанию стоит логин Vyacheslav и я сравниваю введенный мною пароль с паролем, который находится в файле.
login = 'Vyacheslav'
print(f'{login}, Доброго времени суток!')
